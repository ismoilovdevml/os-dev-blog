...
Linuxda grafika tarixi o'ttiz yildan ortiq davom etadigan va Linux yadrosining o'zi evolyutsiyasi bilan uzviy bog'liq bo'lgan sayohatdir. Bu innovatsiyalar, hamjamiyat hamkorligi va yuqori samarali, to'liq ochiq manbali grafik stekga tinimsiz intilish bilan ajralib turadigan hikoya.

Erta kunlar (1990-yillar)

Sayohat 1990-yillarning boshida, Linux yadrosi Linus Torvalds tomonidan birinchi marta chiqarilgandan so'ng boshlangan. Dastlabki kunlarda Linux o'ziga xos grafik tizimiga ega emas edi. U asosan buyruq qatori interfeyslari orqali boshqarildi, grafik displeylar uchun juda oddiy yordam bilan. Ammo foydalanuvchilar uchun qulayroq interfeysga ehtiyoj paydo bo'lishi bilan, X11 yoki oddiygina X deb nomlanuvchi X Window System Unix dunyosidan qabul qilindi.

Dastlab 1984 yilda Massachusets texnologiya institutida ishlab chiqilgan X Window System grafik tasvirlarni ko'rsatish va oynalarni boshqarish uchun asosiy mexanizmlarni taqdim etdi, ammo u standart ko'rinish va hisni aniqlamadi. Ushbu moslashuvchanlik KDE va GNOME kabi turli xil ish stoli muhitlarini tug'dirdi, ularning har biri o'ziga xos estetika va xatti-harakatlarga ega.

Grafik stekni etishtirish (2000-yillar)

2000-yillarning boshida to'g'ridan-to'g'ri ko'rsatish infratuzilmasi (DRI) ko'rinishida sezilarli yutuqlarga erishildi. DRI ilovalarga X serverini chetlab o'tish va grafik qurilmalarga to'g'ridan-to'g'ri kirish imkonini berdi, bu esa ishlashning sezilarli yaxshilanishiga olib keldi, ayniqsa 3D grafikalar va o'yinlar uchun juda muhim.

2000-yillarda, shuningdek, Linux platformasida OpenGLni amalga oshiruvchi ochiq kodli loyiha Mesa ning rivojlanishi va etukligi kuzatildi. Mesa apparat tezlashtirilgan 3D grafikalarni taqdim etish uchun DRI bilan birgalikda ishladi. Taxminan bir vaqtning o'zida, grafik karta ishlab chiqaruvchilari, ayniqsa Nvidia va AMD, Linux uchun xususiy drayverlarni taklif qila boshladilar, bu esa grafik ish faoliyatini yanada yaxshilaydi.

Modernizatsiya sari (2010-yillar)

Ushbu yutuqlarga qaramay, X Window System o'zining cheklovlariga ega edi, birinchi navbatda uning yoshi va dizayn falsafasidan kelib chiqqan holda, zamonaviy grafik qurilmalardan to'liq foydalana olmagan. Yechim 2008 yilda Kristian Xogsberg tomonidan boshlangan yangi displey protokoli Wayland ko'rinishida paydo bo'ldi. Wayland zamonaviy kompozitsion oyna boshqaruvchilari bilan yaratilgan soddaroq va samaraliroq displey tizimini taqdim etish orqali X11 o'rnini bosishni maqsad qilgan.

Bu davrda yana bir muhim texnologiya, yadro rejimini sozlash (KMS) paydo bo'ldi. KMS ko'chirilgan rejimni sozlash vazifalari, jumladan, grafik rejimlarni tanlash va ramka buferlarini o'rnatish, Linux yadrosiga. Bu yuklash jarayonlari va ruxsatni o'zgartirish tugmachalarini yumshatishga olib keldi, shuningdek, yanada ilg'or grafik texnologiyalar uchun poydevor qo'ydi.
