...
`VRAM` Video Random Access Memory - bu GPU grafik tasvirlarni yaratish uchun zarur bo'lgan ma'lumotlarni saqlash uchun foydalanadigan xotira. Bunga teksturalar, vertex ma'lumotlari va yakuniy ko'rsatilgan tasvirni saqlaydigan frame bufferi kiradi. VRAM odatda tezroq va tizimning asosiy xotirasidan ajralib turadi, bu GPUga grafik maʼlumotlarga tez kirish va qayta ishlash imkonini beradi.
